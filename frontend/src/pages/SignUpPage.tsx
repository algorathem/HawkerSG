...
export default function SignUpPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // SUCCESS HANDLER: Redirect to the login page
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className={`px-4 py-3 border rounded-lg text-sm font-medium transition-colors ${formData.userType === 'consumer'
                            ...
                            <button
                                ...
                                className={`px-4 py-3 border rounded-lg text-sm font-medium transition-colors ${formData.userType === 'business'
                                        ? 'border-red-500 bg-red-50 text-red-700'
                                        : 'border-gray-300 text-gray-700 hover:border-gray-400'
                                    }`}
                            >
